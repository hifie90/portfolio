...
import HeroImage from "../assests/portfolio/HeroImage.png"
   ...
   via-black to-gray-800'>
       ...
       justify-center h-full px-4 md:flex-row'>
        <div className='flex flex-col justify-center h-full'>
          <h2 className='text-4xl sm:text-7xl font-bold text-white'> My name is Prasansha Tamang</h2>
          <p className='text-gray-500 py-4 max-w-md'>
            I have joined Sunway College. 
            I am aspiring to a data analytics.
            hoho~ 
          </p>
